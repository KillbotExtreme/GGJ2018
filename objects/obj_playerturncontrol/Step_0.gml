...
if mode>3{
mode=1;
a=instance_create_layer(arrowx,1150,layer,obj_testball);
with(a){
motion_set(obj_playerturncontrol.arrowangle,
		  (obj_playerturncontrol.powerlevel/13.215)+3);
spin_dir=obj_playerturncontrol.weightside;}
arrowangle=90;}
